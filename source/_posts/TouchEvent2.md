...
1.MotionEvent.ACTION_DOWN 都不拦截	
 ...
 ViewGroup1 	  dispatchTouchEvent()	29 =>	 (mGroupFlags & FLAG_DISALLOW_INTERCEPT)==0

​							=> 33 => 58 => 68 => 122 =>	dispatchTransformedTouchEvent有子view重复上面流程  => dispatchTransformedTouchEvent没有子View =>

View					dispatchTouchEvent() 36 => 54 result=false =>事件开始往回传=>

ViewGroup2		122=>163=> 164 dispatchTransformedTouchEvent child传null =>开始调用View dispatchTouchEvent()=false =>  事件继续回传=> 

ViewGroup1			=>重复上面ViewGroup2的流程 => 164 handled=false =>

Activity					=>5  getWindow().superDispatchTouchEvent(ev)   => onTouchEvent(ev);



##### 图ACTION_MOVE UP分析 ViewGroup1  onInterceptTouchEvent =true



 Activity		  	dispatchTouchEvent()	1 => 5

 ViewGroup1 	  dispatchTouchEvent()	29 =>	 (mGroupFlags & FLAG_DISALLOW_INTERCEPT)==0 => 164 >handler = false =>
...
##### 图ACTION_MOVE UP分析 View touchevent = true
 ...
 ViewGroup1 	  dispatchTouchEvent()	29 =>	41 => 170 => 183 遍历查找消费event的View => handled = true
